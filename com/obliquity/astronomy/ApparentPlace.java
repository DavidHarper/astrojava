...
public class ApparentPlace {
	MovingPoint observer;
	MovingPoint target;
	MovingPoint sun;
	EarthRotationModel erm;
    ...
    public ApparentPlace(MovingPoint observer, MovingPoint target, MovingPoint sun,
    		EarthRotationModel erm) {
    ...
    public Vector getDirectionCosines() { return dc; } 
